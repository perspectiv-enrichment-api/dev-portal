...
// ── Step 4 ────────────────────────────────────────────────────────────────────
function StepVerify({ onBack }: { onBack: () => void }) {
...
export const RegisterForm = ({
  ...
  return (
    <>
      ...
      {step === 1 && <StepCompany onNext={next} onBack={back} />}
      {step === 2 && <StepPassword onNext={next} onBack={back} />}
      {step === 3 && <StepVerify onBack={back} />}
    </>
  );
};
